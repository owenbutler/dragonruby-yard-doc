module GTK
  class Controller
    ...
    # @return [true,false] Returns true if a controller is connected. If this value is false, controller properties will not be nil, but return 0 for directional based properties and false button state properties.
    attr_reader :connected

    # @return [String] String value representing the controller’s name.
    attr_reader :name

    # @return [true,false] Returns true if any of the controller’s buttons were used.
    attr_reader :active

    # @return [true,false] Returns true if up is pressed or held on the directional or left analog.
    attr_reader :up

    # @return [true,false] Returns true if down is pressed or held on the directional or left analog.
    attr_reader :down

    # @return [true,false] Returns true if left is pressed or held on the directional or left analog.
    attr_reader :left

    # @return [true,false] Returns true if right is pressed or held on the directional or left analog.
    attr_reader :right
    ...
    # @return [true,false] Returns true if up is pressed or held on the dpad.
    attr_reader :dpad_up, :directional_up

    # @return [true,false] Returns true if down is pressed or held on the dpad.
    attr_reader :dpad_down, :directional_down

    # @return [true,false] Returns true if left is pressed or held on the dpad.
    attr_reader :dpad_left, :directional_left

    # @return [true,false] Returns true if right is pressed or held on the dpad.
    attr_reader :dpad_right, :directional_right

    # @return [true,false] Returns true if the specific button is pressed or held.
    ...
    # @return [true,false] Returns true if the specific button was pressed on this frame.
    ...
    # @return [true,false] Returns true if the specific button is being held.
    #   button can be one of: (a|b|x|y|l1|r1|l2|r2|l3|r3|start|select)
    ...
    #
    # @return [true,false] Returns true if the Left Analog Stick is tilted.
    ...
    # The threshold_raw is a number between 0 and 32,767, and the threshold_perc is a number between 0 and 1.
    #
    # @return [true,false] Returns true if the Right Analog Stick is tilted.
